...
function fpsBaseTailwind_scripts()
{
    ...
    wp_enqueue_style('main', get_template_directory_uri() . '/assets/dist/css/tailwind.css', null, '1.0', false);
    wp_enqueue_script('theme-scripts', get_template_directory_uri() . '/assets/dist/js/main.js', array('jquery'), '0.1', true);
}
